...
import com.bidv.rest.webservices.restfullwebservices.model.ResponseFile;
...
public class DocumentController {
	...
	@Autowired
	  ...
	  public ResponseEntity<List<ResponseFile>> getListFiles() {
	    List<ResponseFile> files = docService.getAllFiles().map(dbFile -> {
	  ...
	  public ResponseEntity<byte[]> getFile(@PathVariable String id) {
	    DocumentEntity fileDB = docService.getFile(id);
